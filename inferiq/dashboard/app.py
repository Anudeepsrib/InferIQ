...
from inferiq.gateway.schemas import ModelBackend
    ...
    for json_file in results_dir.glob("*.json"):
        try:
            ...
            if "raw_results" in data:
                from inferiq.gateway.schemas import GenerateResult
            ...
            if "latency" in data:
                from inferiq.benchmark.metrics import LatencyMetrics
            ...
            if "gpu" in data:
                from inferiq.benchmark.metrics import GPUMetrics
            ...
            if "cost" in data:
                from inferiq.benchmark.metrics import CostMetrics
